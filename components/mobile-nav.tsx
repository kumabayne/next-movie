  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-background p-2">
      <ul className="grid grid-cols-5">
        ...
        <li className="flex justify-center">
          <Link className="inline-flex flex-col items-center" href="/movies">
            <FilmIcon strokeWidth="1.5" />
            <span className="text-xs font-medium">Movies</span>
          </Link>
        </li>
        <li className="flex justify-center">
          <Link className="inline-flex flex-col items-center" href="/tv">
            <TvIcon strokeWidth="1.5" />
            <span className="text-xs font-medium">TV</span>
          </Link>
        </li>
        <li className="flex justify-center">
          <Link className="inline-flex flex-col items-center" href="/people">
            <UsersIcon strokeWidth="1.5" />
            <span className="text-xs font-medium">People</span>
          </Link>
        </li>
        <li className="flex justify-center">
          <Link className="inline-flex flex-col items-center" href="/profile">
