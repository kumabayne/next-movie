    ...
    <Sheet>
      ...
      <SheetContent className="pt-12" side="left">
        <div className="flex h-full flex-col justify-between gap-2">
          ...
          >
            Open the accordions below to access links for movies, tv shows,
            people and more
          </SheetDescription>
          <Accordion type="single" collapsible>
            ...
            <AccordionItem value="movies">
              <AccordionTrigger className="py-2 hover:no-underline">
                <div className="flex gap-2">
                  <IconMovie className="h-6 w-6 text-indigo-600" stroke="1.5" />{" "}
                  Movies
                </div>
              </AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem className="border-b-0" value="people">
              <AccordionTrigger className="py-2 hover:no-underline">
                <div className="flex gap-2">
                  <IconUsers className="h-6 w-6 text-indigo-600" stroke="1.5" />{" "}
                  People
                </div>
              </AccordionTrigger>
              <AccordionContent>
