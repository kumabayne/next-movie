  ...
  return (
    <div>
      <Link className="block relative" href={`/movie/${item.id}`}>
        <div className="relative text-center lg:max-h-[600px] after:absolute after:inset-0 after:z-10 after:bg-gradient-to-t after:from-slate-950 after:to-transparent">
          <Image
        ...
        <Container className="absolute bottom-0 z-20">
          <div className="grid gap-2 grid-cols-[60px_auto] items-end md:grid-cols-[120px_auto] xl:grid-cols-[240px_auto] md:gap-4 lg:gap-6">
            ...
            <div>
              <h2 className="font-semibold text-zinc-100 md:text-3xl md:font-bold xl:text-4xl">
                {item.title}
              </h2>
            </div>
          </div>
